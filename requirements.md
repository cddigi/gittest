...
<table>
  ...
  <tr>
    ...
    <td>Title of Position prior to Graduate School</td>
    <td>Birthdate</td>
  </tr>
  <tr>
...
All Users, Graduate Office Employees, and the Administrator should have a navigation area with the available actions that each type of user can accomplish. Only the Administrator will have the ability to add, update, and delete any account. A Graduate Office account can only add or update a User account.

Users need the ability to choose whether or not their information is associated with survey responses in order to keep their responses anonymous; ability to access their account settings and in some way opt-out of the following three categories of automated email that may be sent: All, Surveys, News.

There must be a password reset option. User passwords can be reset by Administrator or Graduate Office. Graduate Office password can only be reset by Administrator.
<br /><br /><hr />
...
There needs be the ability to create reports based on survey results and search queries with a number of preset options, as well as the ability to create custom reports. These should be able to be exported into Excel spreadsheet format for easier viewing and management.
<br /><br /><hr />
...
Graduate Office Employees have the ability to search through the database information by any of the information that a User has provided to their account. After a search has been completed, the Office Employee should be able to save the search result in a Saved List. The information displayed in a search result should be limited to name, degree program, email, employer, graduation date, and any other fields the Office Employee used to search so as to not clutter the screen. The Saved Lists need to be exportable into an Excel spreadsheet, as well as exporting the emails for use in Groupwise.
