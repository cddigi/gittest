...
Users need the ability to choose whether their information is associated with survey responses in order to keep their responses anonymous; ability to access their account settings and in some way opt-out of the following three categories of automated email that may be sent: All, Surveys, News. 

There must be a password reset option. Administrator or Graduate Office can reset user passwords. Administrator can only reset graduate Office password. 
<br /><br /><hr />
...
The Graduate Office has the ability to search through the database information by any of the information that a User has provided to their account. After a search has been completed, the Office Employee should be able to save the search result in a Saved List. The information displayed in a search result should be limited to name, degree program, email, employer, graduation date, and any other fields the Office Employee used to search to not clutter the screen. The Saved Lists need to be exportable into an Excel spreadsheet, as well as exporting the emails for use in Groupwise. 
